...
class Minkasu2FAUtil {
    ...
    static final String RCT_MINKASU_2FA_SDK_VERSION = "4.2.13161";
    ...
    static void initSDK(Activity mActivity, @NonNull WebView view, String config, String initType) {
        ...
        try {
            synchronized (LOCK) {
                if (previousMKConfig != null && previousMKConfig.equalsIgnoreCase(config)) {
                    return;
                }
                previousMKConfig = config;
            }
